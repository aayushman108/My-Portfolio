  ...
  return (
    ...
    >
      ...
      <div className="section-container px-4 sm:px-6 pt-32 pb-20">
        {/* Page Header */}
        <div className="page-header mb-16 md:mb-20 opacity-0">
          {/* Back Link */}
          <Link
            href="/"
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
            {Object.entries(techStack).map(
              ([category, skills], categoryIndex) => (
                <div key={categoryIndex} className="tech-category opacity-0">
        ...
        {/* Connect CTA */}
        <div className="about-cta opacity-0 pt-12 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-12 h-12 rounded-full border-2 border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:border-gray-900 dark:hover:border-white hover:bg-gray-900 dark:hover:bg-white hover:text-white dark:hover:text-black transition-all duration-300"
                aria-label="GitHub"
              >
                <FaGithub size={20} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full border-2 border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:border-blue-600 dark:hover:border-blue-400 hover:bg-blue-600 dark:hover:bg-blue-400 hover:text-white transition-all duration-300"
                aria-label="LinkedIn"
              >
                <FaLinkedin size={20} />
              </a>
              <a
                ...
                className="w-12 h-12 rounded-full border-2 border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:border-purple-600 dark:hover:border-purple-400 hover:bg-purple-600 dark:hover:bg-purple-400 hover:text-white transition-all duration-300"
                aria-label="Email"
              >
                <FaEnvelope size={20} />
              </a>
              <Link
                href="/#contact"
                className="group inline-flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-gray-900 dark:bg-white text-white dark:text-black rounded-full font-semibold text-sm md:text-base hover:bg-purple-600 dark:hover:bg-purple-400 transition-all duration-300 ml-2"
              >
